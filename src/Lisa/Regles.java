...
public class Regles extends JFrame {
	...
	public Regles() {
		...
		JLabel lblNewLabel_7 = new JLabel("ATTENTION : si 2 trains de m\u00EAme longueur arrivent en m\u00EAme temps \u00E0 un aiguillage cela entra\u00EEne directement la fin de la partie");
